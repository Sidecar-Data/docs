...
## Enable dbt Cloud tools

For live job inspection, model diagnostics, and run retries, [enable dbt Cloud
MCP](/integrations/mcp-servers/dbt-cloud), then grant it to the agent. This is a
separate step from connecting dbt metadata and does not provide repository access.
