...
## Add Snowflake MCP to Agent Console

After the warehouse connection is saved, follow [Set up Snowflake MCP](/integrations/mcp-servers/snowflake)
to give Sidecar agents read-only query access.
