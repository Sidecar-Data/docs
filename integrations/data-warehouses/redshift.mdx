...
The warehouse connection above does not automatically provide Redshift tools to
agents. Follow [Set up Redshift MCP](/integrations/mcp-servers/redshift) to host
and register a compatible remote endpoint.
