...
<CardGroup cols={2}>
  <Card title="dbt Cloud MCP" icon="cloud" href="/integrations/mcp-servers/dbt-cloud">
    Give agents dbt Cloud investigation and retry tools.
  </Card>
...
<Tabs>
  ...
  <Tab title="dbt Cloud">
    ...
    Follow [dbt Cloud MCP](/integrations/mcp-servers/dbt-cloud) for prerequisites and setup instructions.
  </Tab>
</Tabs>
